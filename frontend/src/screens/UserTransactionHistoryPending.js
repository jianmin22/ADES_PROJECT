...
function UserTransactionHistoryPending() {
  const { auth } = useAuth();
        ...
        ? transactionFetched && (
            <div className="h-screen flex flex-col justify-center items-center bg-orange-100">
              <h1 className="text-3xl font-bold mb-5">
                No pending for delivery transaction history
              </h1>
              <Link to="/shop/search">
        ...
        : transactionFetched && (
            <div className="bg-orange-300 min-h-screen">
              <h1 className="text-3xl font-bold mx-10 mb-5 pt-5">
                Your Pending For Delivery Transaction History
              </h1>
              {transactionHistory.map((transaction) => (
                ...
                >
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between w-full">
                        <div className="flex flex-col">
                          ...
                          <p className="flex-grow break-all px-4">{item.productDesc}</p>
                          <p className="px-4">${parseFloat(item.price).toFixed(2)}</p>
                  ...
                  <p>Voucher:{" "}{(transaction.voucherName)?(transaction.voucherName):"No Voucher Applied"}</p>
                </div>
              ))}
...
export default UserTransactionHistoryPending;
